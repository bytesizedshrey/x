...
export default function PixelCard({ variant = 'default', gap = undefined, speed = undefined, colors = undefined, noFocus = undefined, className = '', children }) {
  ...
  return (
    <div
      ref={containerRef}
      className={`relative overflow-hidden grid place-items-center bg-black/40 backdrop-blur-md border border-white/10 rounded-[25px] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none shadow-xl ${className}`}
